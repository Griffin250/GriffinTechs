...
import Gadgets from '../../src/assets/bannerImages/Pc.jpeg'
...
const Product = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-gray-50 to-orange-50 p-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600">
          ...
          work, our experts can help you choose the best quality product to
          meet your needs.
        </p>
      </div>
   ...
   <div className="text-center mt-20">
        ...
        <NavLink to='/contactForm' onClick={scrollToTop}>  <button className="btn px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 shadow-lg transition-all">
          Talk to an Expert  <FontAwesomeIcon icon={faArrowRight} className="right-arrow ml-2 w-6"/>
        </button></NavLink>
